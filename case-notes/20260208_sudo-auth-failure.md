...
The activity was reproduced intentionally (3 wrong password attempts) to validate log collection and alerting.
...
## 2) Detection details
- Alert / Rule: Three failed attempts to run sudo
- Rule ID: 5404
- Rule level: 10
...
### Raw log excerpt
> 2026-02 HOST-001 sudo[XXXX]: john : 3 incorrect password attempts ; TTY=pts/0 ; PWD=/home/john ; USER=root ; COMMAND=/usr/bin/ls /root
